...
jQuery(function ($) {
	...
	jQuery(document).ready(function ($) {
	    ...
	    //$('.mobile-menu-list .menu-item-has-children').append('<span class="sub-menu-toggle"></span>');
	   // $('.mobile-menu-list .sub-menu').hide();

	    $('.mobile-menu-list .sub-menu-toggle').click(function (e) {
	     //   e.preventDefault();
